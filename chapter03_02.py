...
# Hash 값 확인
t1 = (10, 20, (30, 40, 50)) # 값변경X 불변
t2 = (10, 20, [30, 40, 50]) # 값변경O 
...
with open('./resources/test1.csv', 'r', encoding='UTF8') as f:
    temp = csv.reader(f)
    # Header Skip
    next(temp)
    # 변환
...
user_dict3 = UserDict([('one', 1), ('two', 3)])
