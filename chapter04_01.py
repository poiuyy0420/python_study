...
print('EX1-4 -', sorted(set(dir(factorial))-set(dir(A)))) # 함수만 갖고 있는 속성 확인
...
# 함수 인수 전달 및 함수로 결과로 반환 -> 고위 함수(Higher-order Function)
...
print('EX4-2 -', callable(str), callable(list), callable(factorial), callable(3.14), callable(game))
print('EX4-3 -', game())
...
# partial 사용법 : 인수 고정 -> 주로 특성 인수 고정 후 콜백 함수에 사용
...
print('EX7-3 -', six())
# 1*5, 2*5, 3*5, 4*5
print('EX7-3 -', [five(i) for i in range(1, 11)])
