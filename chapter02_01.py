...
print('EX3-2 - ', p1.x + p2.y) # 클래스 변수 접수 방식
...
print('확인1 - ', students[4])
print('확인2 - ', students[4].rank)


# 가독성 X
students2 = [Classes(rank, numbers) for rank in 'A B C D'.split() for numbers in [str(n) for n in range(1,21)]]
