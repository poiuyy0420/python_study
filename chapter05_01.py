...
bastket1 = Basket(['Apple', 'Bag', 'TV', 'Snack', 'Water'])
bastket2 = copy.copy(bastket1)
bastket3 = copy.deepcopy(bastket1)

print('EX5-1 -', id(bastket1), id(bastket2), id(bastket3))
print('EX5-2 -', id(bastket1._products), id(bastket2._products), id(bastket3._products))

print()

bastket1.put_prod('Orange')
bastket2.del_prod('Snack')

print('EX5-3 -', bastket1._products)
print('EX5-4 -', bastket2._products)
print('EX5-5 -', bastket3._products)
...
print('EX6-3 -', mul(c, d), c, d) # 불변형 c -> 데이터 변경 안됨
